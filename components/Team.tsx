      ...
      <div className="container px-6 py-10 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
          ...
          <div className="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
            ...
            <div className="">
              <p className="mb-4">
                Grant realised his childhood dream of flying in 2008 when he
                got his paragliding license through Birdmen.
              </p>
              <p className="mb-4">
                However, without support and conflicting life demands, Grant fell out of
                the sport for four years. Thanks to a chance meeting with Barry
                and the support of fellow Birdmen, Grant was able to get back
                into the sport and has been flying ever since.
              </p>
              <p className="mb-4">
